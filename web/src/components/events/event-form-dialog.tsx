...
function initialForm(event: EventRecord | null): EventFormState {
  return {
    ...
    template_id: event ? String(event.template_snapshot.template_id) : "",
    filter_id: event ? String(event.filter_snapshot.filter_id) : "",
    camera_profile_id: event ? String(event.camera_snapshot.camera_profile_id) : "",
    printer_profile_id: event ? String(event.printer_snapshot.printer_profile_id) : "",
