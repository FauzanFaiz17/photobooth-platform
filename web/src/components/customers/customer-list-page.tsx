    ...
    <div className="min-w-0 space-y-6 p-4 sm:p-6 lg:p-8">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Data Customer yang dicatat melalui aplikasi desktop. Halaman ini hanya
          dapat dibaca.
        </p>
      </header>
      ...
      {state === "success" && (
        <Card>
          <CardHeader className="gap-4 border-b">
            ...
            >
              <form key={search} className="flex gap-2" onSubmit={submitSearch}>
                  ...
                  <TableBody>
                    {response.data.map((customer) => (
                      <TableRow key={customer.id}>
                        ...
                        {superAdmin && (
                          <TableCell>
                            {partnerName(customer.partner_id)}
                          </TableCell>
                        )}
